export const es = {
  ...
  pages: {
    ...
    comentarios: {
      ...
      // Formulario para que los integrantes dejen su comentario.
      // Los envíos NO se publican solos: llegan por correo y CNV los revisa.
      form_tag: 'Deja tu comentario',
      form_title: '¿Operas el modelo? Cuéntanos tu experiencia',
      form_body: 'Si eres integrante de la red CNV, comparte cómo cambió tu consulta. Tu comentario aparecerá en esta misma página.',
      f_name: 'Nombre y apellido',
      f_role: 'Perfil profesional',
      f_role_ph: 'Ej.: Medicina funcional, Nutrición y dietética',
      f_location: 'Ciudad y país',
      f_email: 'Correo electrónico',
      f_email_help: 'No se publica. Lo usamos solo para verificar y responderte.',
      f_comment: 'Tu comentario',
      f_comment_ph: '¿Qué cambió en tu consulta desde que operas el modelo ANI BIS-E?',
      f_consent: 'Autorizo a CNV a publicar este comentario en su sitio web junto a mi nombre, perfil profesional y ciudad. Puedo pedir su retiro en cualquier momento escribiendo a gerencia@cnvsystem.com.',
      f_consent_error: 'Necesitamos tu autorización para poder publicar el comentario.',
      submit: 'Enviar comentario',
      sending: 'Enviando…',
      ok_title: '¡Gracias por compartir tu experiencia!',
      ok_body: 'Tu comentario ya está publicado en esta página. Recarga para verlo junto a los demás.',
      err: 'No pudimos enviar tu comentario. Inténtalo de nuevo o escríbenos a gerencia@cnvsystem.com.',
      err_fields: 'Completa tu nombre, correo y comentario para continuar.',
      err_captcha: 'Completa la verificación de seguridad.',
      moderation_note: 'Al enviarlo, tu comentario queda publicado en esta página. CNV puede retirarlo si no cumple con las normas de la comunidad o si tú lo solicitas.',
      live_tag: 'De la comunidad',
      live_title: 'Comentarios de la red',
      live_count_one: 'comentario publicado',
      live_count_many: 'comentarios publicados',
    },
  },
} as const;
