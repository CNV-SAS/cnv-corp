export const es = {
  ...
  pages: {
    ...
    comentarios: {
      ...
      form_body: 'Si eres integrante de la red CNV, comparte cómo cambió tu consulta. Revisamos cada comentario antes de publicarlo.',
      ...
      ok_body: 'Recibimos tu comentario. Lo revisaremos y, si lo publicamos, aparecerá en esta página. Te escribiremos al correo que nos dejaste.',
      ...
      moderation_note: 'Los comentarios no se publican automáticamente: pasan por revisión de CNV antes de aparecer en el sitio.',
    },
  },
} as const;
