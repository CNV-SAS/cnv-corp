export const es = {
  ...
  pages: {
    ...
    operacion: {
      ...
      hero_body: 'CNV Care es la línea operativa responsable de la implementación, soporte y control del modelo de atención en salud ANI-BIS-E en contextos reales.',
    },
    formacion: {
      tag: 'CNV Learning',
